...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_FIRST] = LAYOUT(
        ...
        KC_LCTL,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                      KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, ST_MINS,
                                            LT_MHEN,  RT_SPC, XXXXXXX,  SECOND,  RT_ENT, LT_HENK
    ),
    /*
    [_SECOND] = LAYOUT(
    ...
    */
    ...
    [_ADJUST] = LAYOUT(
        ...
        AT_CAPS, _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI,                   _______, _______, _______, _______, _______,  KC_F12,
        _______, _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD,                    TENKEY,  SECOND, _______, _______, _______, LSFT_T(KC_PWR),
                                            _______, _______, _______, _______, _______, _______
    ),
};
