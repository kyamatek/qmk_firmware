...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // |-------+-------+-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------+-------+-------+-------|
        KC_LCTL,                        LT_MHEN,RT_SPC ,CONFIG ,     SECOND ,RT_ENT ,LT_HENK                                ,RT_ENT
    // `-------+-------+-------+-------+-------+-------+-------|    |--------------+-------+-------+-------+-------++-------+-------'
    ),
    ...
    // |-------+-------+-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------+-------+-------+-------|
        _______,                        _______,_______,_______,     _______,KC_LCTL,KC_LALT                                ,_______
    // `-------+-------+-------+-------+-------+-------+-------|    |-------+------+-------+-------+-------+-------++-------+-------'
    ),
    [_TENKEY] = LAYOUT(
    // ,-------+-------+-------+-------+-------+-------|                            |-------+-------+-------+-------+-------+-------.
    ...
    // |-------+-------+-------+-------+-------+-------+-------|    |-------+-------+-------+-------+-------+-------+-------+-------|
        _______,                        LOWER  ,RT_SPC ,XXXXXXX,     FIRST  ,KC_0   ,XXXXXXX                                ,_______
    // `-------+-------+-------+-------+-------+-------+-------|    |-------+------+-------+-------+-------+-------++-------+-------'
    ),
    [_CONFIG] = LAYOUT(
    // ,-------+-------+-------+-------+-------+-------|                            |-------+-------+-------+-------+-------+-------.
